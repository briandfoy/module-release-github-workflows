...
=head1 The Module::Release::GitHub::Workflows module

This is the I<README> for the L<Module::Release::GitHub::Workflows> Perl module.
...
To read about L<Module::Release::GitHub::Workflows>, look at the embedded documentation
in the module itself. Inside the distribution, you can format it
with L<perldoc|http://perldoc.perl.org/perldoc.html>:

	% perldoc lib/Module/Release/GitHub/Workflows.pm

If you have already installed the module, you can specify the module
name instead of the file location:

	% perldoc Module::Release::GitHub::Workflows

You can read the documentation and inspect the meta data on
L<MetaCPAN|http://www.metacpan.org/pod/Module::Release::GitHub::Workflows>.
...
and install the dependencies:
	...
	% cpan Module::Release::GitHub::Workflows
	% cpanm Module::Release::GitHub::Workflows
...
You need a GitHub account and the L<gh tool|https://github.com/larsks/ghcli>.
	...
	$ gh auth login
	...follow instructions...
	$ gh attestation verify Module::Release::GitHub::Workflows-1.23.tar.gz --owner briandfoy
